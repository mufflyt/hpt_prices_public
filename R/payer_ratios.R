...
payer_ratio_sql <- function(codes, exclude_file_ids = NULL) {
  ...
  base::paste0(
    ...
    "         CAST(payer_type AS VARCHAR) AS payer_type, payer_name, plan_name, case_dollar\n",
    ...
    "),\n",
    "plan_rates AS (\n",
    "  SELECT unit_id, concept, code, fee_type, payer_type, payer_name, plan_name, median(case_dollar) AS plan_median\n",
